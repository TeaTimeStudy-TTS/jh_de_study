...
def _extract_cb(**kwargs):
  '''
    ...
    - parameters
      - kwargs : airflow가 작업 실행하기 전에 정보(airflow의 내부에 구성되어 있는 context(딕셔너리구조))를 접근할수 있는 내용
  ...
  logging.info(f'작업시작 {execute_date}, 실행 ID {run_id}')
  logging.info('== Extract 끝 end ==')
